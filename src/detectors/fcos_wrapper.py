...
class FCOSWrapper(BaseDetector):
    ...
    def _lazy_init(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "MMDetection is not installed yet. Install it on the GCP VM before using FCOSWrapper."
            ) from exc
    ...
    def predict(self, image_path: str) -> List[Detection]:
        ...
        raise NotImplementedError(
            "FCOS result parsing will be finalized on the GCP VM after MMDetection is installed."
        )